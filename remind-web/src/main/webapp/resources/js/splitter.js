 ...
 $.fn.splitter = function(args){
	...
	return this.each(function() {
		...
		function resplit(newPos) {
			...
			// Resize inner div in richfaces panels on deployment.xhtml
			adjustComponentsDimensions();
		}
		function adjustComponentsDimensions() {
		...
		var bar = $(panes[2] || '<div id="splitBar"></div>')
